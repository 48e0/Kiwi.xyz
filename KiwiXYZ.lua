...
function KiwiLibrary:CreateWindow()
    ...
    function WindowObject:CreateTab(TabName, IconName)
        ...
        -- SISTEMA DE SCROLL AUTOMÁTICO CORREGIDO
        ...
        -- SECCIÓN CORREGIDA CON MARGEN
        function TabElements:CreateSection(SectionTitle, Side)
            local SectionFrame = Instance.new("Frame")
            SectionFrame.Parent = GetTargetColumn(Side)
            SectionFrame.BackgroundTransparency = 1
            SectionFrame.Size = UDim2.new(1, 0, 0, 40) -- Mayor altura general

            local SectionLabel = Instance.new("TextLabel")
            SectionLabel.Parent = SectionFrame
            SectionLabel.BackgroundTransparency = 1
            SectionLabel.Position = UDim2.new(0, 0, 0, 12) -- Margen superior de 12 pixeles
            SectionLabel.Size = UDim2.new(1, 0, 0, 20)
            SectionLabel.Font = Enum.Font.GothamBold
            SectionLabel.Text = SectionTitle
            SectionLabel.TextColor3 = Theme.Text
            SectionLabel.TextSize = 14 -- Fuente ligeramente más grande
            ...
            SectionLine.Position = UDim2.new(0, 0, 0, 34) -- Posicionado justo debajo del texto
